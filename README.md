...
Campfire is a lightweight PHP application that sends periodic emails to troop families with upcoming events from your Scoutbook Plus calendar and per-family scout account balances. It replaces the automated newsletter feature from platforms like TroopWebHost with something simpler, focused, and free.
